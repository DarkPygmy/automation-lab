...
test("can search Google twice", async () => {
  ...
  await driver.wait(until.titleIs('pikachu - Google Search'), 3000)
  ...
  await driver.findElement(By.name('q')).sendKeys('Baldurs Gate 1', Key.RETURN)
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("Baldurs Gate 1 - Google Search"), 1000)
});
